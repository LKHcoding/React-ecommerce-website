...
const items = [
...

  {
    ...
    caption: "202 QLED 8K",
    text: "감각의 한계를 넘어서다",
    text2: "전체 QLED 8K보기",button: "info"
  },
...
function IndexHeader() {
  ...
  return (
    <>
      <div className="page-header clear-filter" id="carousel" ref={pageHeader}> {/*메인사진 안 텍스트 & 버튼 */}
              ...
              >
                ...
                {/* 양사이드 왼오 */}
                <button
                  className="carousel-control-prev"  style={{border:"solid 1px red",top:"350px",height:"100px",width:"100px",left:"50px"}}
                  data-slide="prev"
                  href="#pablo"
                  onClick={(e) => {
                    e.preventDefault();
                ...
                <button
                  className="carousel-control-next" style={{border:"solid 1px blue",top:"350px",height:"100px",width:"100px",right:"50px"}}
                  data-slide="next"
                  href="#pablo"
